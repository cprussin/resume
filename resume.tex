...
\begin{document}
	...
	\begin{section}{Experience}
		\begin{experience}{Full-Stack Developer}{Netflix}
			...
			\item Led implementation of a major tool with thousands of daily users,
			      including hundreds of external agencies
			\item Contributed features and bugfixes to a number of Netflix-internal
			      tools
			\item Developed and led implementation of Netflix-internal Ruby gems and
	...
	\begin{section}{Projects}
		\begin{project}{VanDAM}
		               ...
		               {August 2014 - Present}
	    \item Led technical implementation of both frontend and backend
			\item Built major features and bugfixes and significantly improved
			...
			\item Frontend written in Ember.js with Emblem.js, CoffeeScript, and Scss
			\item Backend written in Rails on mysql and ElasticSearch
		\end{project}
