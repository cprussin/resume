	...
	\begin{section}{Experience}
		\begin{experience}{Full-Stack Developer}{Netflix}
			...
			\item Contributed features and bugfixes to a number of Netflix internal
			      tools
			\item Led technical implementation of webapp and REST API for working with
			      and storing marketing assets
			\item Utilized Ruby with Rails and Sinatra for backend, and Ember.js for
				    frontend
		\end{experience}
